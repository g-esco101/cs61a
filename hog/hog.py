...
def get_scores(strategy, score, opponent_score, dice, feral_hogs, prev_score=0):
    """Updates a player's previous score and returns it as well as the 
    current score.
    ...
    strategy:       The strategy function for the Player.
    prev_score:     The Player's score from the prvious round.
...
def announce_highest(who, prev_high=None, prev_score=None):
